...
for run in {5}; do
    ...
    srun python -u /gpfs/home3/tsijpkens/project/TSPHardener/experiment.py "[20]" "[20, 25, 30, 35, 40, 45, 50]" 10000 "" --tsp_type "asymmetric" --distribution "uniform" --mutation_strategy "wouter"
done
