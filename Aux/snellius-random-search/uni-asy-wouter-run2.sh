...
for run in {2}; do
    ...
    srun python -u /gpfs/home3/tsijpkens/project/TSPHardener/experiment.py "[30]" "[40, 45, 50]" 10000 "" --tsp_type "asymmetric" --distribution "uniform" --mutation_strategy "wouter"
done
